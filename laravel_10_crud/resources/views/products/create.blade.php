        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    ...
                    <a href="#" class="btnbtn-primary btn-sm">&larr; Back</a>
                </div>
            </div>
            <div class="card-body">
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <label for="images" class="col-md-4 col-form-label text-md-end text-start">Images</label>
                        ...
                        <input type="file" id="images" name="images"></input>
                            <!-- <input type="file" class="form-control @error('images') is-invalid @enderror" id="images" name="images">{{ old('images') }}</input>
