    ...
    <body style="background: lightgray">
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <h3 class="text-center my-4">Table Nilai Mahasiswa</h3>
                        <hr>
                    </div>

                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <a href="{{ route('grades.create') }}" class="btn btn-md btn-success mb-3">TAMBAH NILAI</a>
                            ...
                            <th scope="col">AKSI</th>
                                ...
                                <tbody>
                                    @forelse ($grades as $post)
                                        <tr>
                                            <td>{{ $post->nama }}</td>
                                            <td>{{ $post->kehadiran }}</td>
                                            <td>{{ $post->tugas }}</td>
                                            <td>{{ $post->uts }}</td>
                                            <td>{{ $post->uas }}</td>
